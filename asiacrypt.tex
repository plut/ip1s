...
\author{Gilles Macario-Rat\inst{1}\and \emph{Jérôme Plût}\inst{2}\and
Henri Gilbert\inst{3}}
\date[2013-12-02]{2013-12-02\par
Full version: {\small \color{bleu}\tt eprint.iacr.org/2013/799}.}
\institute[]{%
...
\item{} {\color{rouge}[Bouillaguet, Faugère, Fouque, Perret 2011]}: transform the
