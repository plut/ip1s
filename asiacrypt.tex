...
\author{G. Macario-Rat\inst{2}, \underline{J. Plût}\inst{1}, H. Gilbert}
\date{XXX date}
\institute[]{%
\inst{1}ANSSI,
...
\titlegraphic{\includegraphics[width=10ex]{anssi-macaron}
% Ratio of π/4 to have the same area
\hfil \raise 1.07ex\hbox{\includegraphics[width=7.85ex]{orange}}}
...
\begin{df}[Identity of polynomials with one secret]
