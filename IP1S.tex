...
\let\old@proof\proof \let\old@eproof\endproof \let\old@qed\qed
\newif\ifqed
\def\proof{\qedtrue\old@proof}
\def\endproof{\ifqed\unskip~\old@qed\fi}
\def\qed{%
\ifmmode \ifmeasuring@ \hskip .5\textwidth minus 2\textwidth\fi
\else \quad\fi\global\qedfalse\old@qed}
\makeatother
% ---
...
\vtop to 0pt{\vskip -2.5ex \hfill \qed \vss}
\end{proof}
...
\end{align*}
\par\vskip-\parskip\vskip-\baselineskip
\vtop to 0pt{\vskip -3.6ex \hfill \qed \vss}
\end{proof}
