...
Prop.~\refe{prop:quad-can}. Since they share the same characteristic
values~$\alpha_1$ and~$\alpha_2$, the possible morphisms are described by
Prop.~\ref{prop:aut-can}~\mkenumi{1}.
