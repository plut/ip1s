...
\let\itemref\ref
% \def\itemref#1{%
% \message{^^J^^JITEMREF(#1)^^J^^J}%
% \message{^^J^^J\expandafter\meaning\csname r@#1\endcsname^^J}%
% \expandafter\ifx\csname r@#1\endcsname\relax
%   {\bfseries ??}\else{unter{enumi}{\ref{#1}}\labelenumi}\fi}
...
%>>>1
\section{Pencils of symmetric bilinear forms}%<<<1
