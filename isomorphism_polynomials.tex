...
variables, the number~$n$ of polynomials, and their degree. For
...
Finally, Berthomieu, Faugère and Perret very recently
proposed~\cite{DBLP:journals/corr/BerthomieuFP13} a polynomial algorithm
solving the \emph{decisional} IP1S problem for any number of equations.
...
case~\cite{milnor1973symmetric}, and relies on symplectic groups and
