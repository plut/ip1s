...
since they use some results of~\cite{DBLP:conf/issac/ChistovIK97} which work in such fields. The also
claim that their algorithm solves the decisional problem and not the computational problem, which is not 
really interesting in cryptography.  
