...
$\bm{a}=t\circ \bm{b}\circ s$. We show a
...
The Isomorphism of polynomial problem has been introduced in cryptography by Patarin in~\cite{DBLP:conf/eurocrypt/Patarin96} to construct an efficient authentication scheme 
as an alternative to the Graph Isomorphism Problem proposed by Goldreich, Micali and Wigderson~\cite{DBLP:journals/jacm/GoldreichMW91}. This problem was appealing since 
it seems more difficult than the Graph Isomorphism problem. A reduction between these
...
matrix of the graphs and the other is cubic of the special form $\sum_{i} x_i^3$ over a 
...
is a classical result of classification of quadratic forms~\cite{lidl1997finite}.
