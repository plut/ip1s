...
In the same way, we see that~$F(H_{d-1}) ⊂ H_{d'-1}$.% à vérifier
...
% a natural bilinear action of~$E_d ⊗ H_m$ on~$H_d$ and~$\chk{H_d}$:
% namely
...
We now state the two lemmas used in the algorithm.% proof of the proposition.
