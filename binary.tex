...
\note{Ceci correspond assez exactement à l'analyse d'IP1S binaire faite à
Asiacrypt (l'application~$θ$ est la même --- même si je préfère largement
la définition actuelle comme adjoint du Verschiebung, les autres sont
nouvelles)}.
